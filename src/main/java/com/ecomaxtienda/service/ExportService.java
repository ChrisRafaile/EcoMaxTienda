...
public class ExportService {
    ...
    public byte[] exportarPedidosPDF(List<Pedido> pedidos, String fechaInicio, String fechaFin, String estados) 
        ...
        Paragraph title = new Paragraph("Reporte de Pedidos - EcoMaxTienda", titleFont);
    ...
    public byte[] exportarReporteGeneralPDF(List<Pedido> pedidos) throws DocumentException, IOException {
        ...
        Paragraph title = new Paragraph("Reporte General de Pedidos - EcoMaxTienda", titleFont);
        title.setAlignment(Element.ALIGN_CENTER);
        title.setSpacingAfter(20);
        document.add(title);
    ...
    public byte[] exportarReporteGeneralExcel(List<Pedido> pedidos) throws IOException {
        ...
        titleCell.setCellValue("Reporte General de Pedidos - EcoMaxTienda");
    ...
    public byte[] exportarProductosPDF(List<Producto> productos) throws DocumentException, IOException {
        ...
        // Título del reporte
        com.itextpdf.text.Font titleFont = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 20, BaseColor.BLACK);
        Paragraph title = new Paragraph("Reporte de Productos - EcoMaxTienda", titleFont);
        title.setAlignment(Element.ALIGN_CENTER);
        title.setSpacingAfter(20);
        document.add(title);
    ...
    public byte[] exportarProductosExcel(List<Producto> productos) throws IOException {
        try (Workbook workbook = new XSSFWorkbook();
            ...
            Row titleRow = statsSheet.createRow(0);
            Cell titleCell = titleRow.createCell(0);
            titleCell.setCellValue("Reporte de Productos - EcoMaxTienda");
            titleCell.setCellStyle(titleStyle);
    ...
    public byte[] generarBoletaPDF(java.util.Map<String, Object> pedido) throws DocumentException, IOException {
        ...
        java.util.Date fechaPedido = (java.util.Date) pedido.get("fechaPedido");
        ...
        Paragraph title = new Paragraph("ECOMAXTIENDA", titleFont);
        title.setAlignment(Element.ALIGN_CENTER);
        ...
        empresaCell.addElement(new Paragraph("EcoMaxTienda E.I.R.L.", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 12)));
        ...
        pedidoCell.addElement(new Paragraph("Fecha: " + new java.text.SimpleDateFormat("dd/MM/yyyy HH:mm").format(fechaPedido), 
        ...
        document.add(new Paragraph("Fecha de Entrega Estimada: " + 
            new java.text.SimpleDateFormat("dd/MM/yyyy").format(
                new java.util.Date(fechaPedido.getTime() + 3 * 24 * 60 * 60 * 1000)), 
            FontFactory.getFont(FontFactory.HELVETICA, 10)));
